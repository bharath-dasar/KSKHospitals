...
const CreateUser = () => {
  ...
  const handleGetAllHospitals = async () => {
    ...
    try {
      ...
      message.error("Error getting all hospitals contact admin");
      console.error(error);
    }
  };

  // useEffect to call handleGetAllDesignations and handleGetAllHospitals on component mount
  useEffect(() => {
                    ...
                    <div className="relative z-20 bg-transparent dark:bg-form-input">
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          changeHospitalTextColor();
                        }}
                        className={`relative z-20 w-full appearance-none rounded border py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${
                          isHospitalSelected 
                      ...
                      >
                        ...
                        {hospitals.map((hospital) => (
                          <option
                            key={hospital.hospitalIdentifier}
                            value={hospital.hospitalIdentifier}
                            className="text-body dark:text-bodydark"
                          >
